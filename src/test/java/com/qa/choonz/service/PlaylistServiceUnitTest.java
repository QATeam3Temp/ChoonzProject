...
public class PlaylistServiceUnitTest {
	...
	void createPlaylistTest() {
		TestWatch.test = report.startTest("Create playlist test - service unit");
	...
	void readPlaylistTest() {
		TestWatch.test = report.startTest("Read playlists test - service unit");
	...
	void readPlaylistIdTest() {
		TestWatch.test = report.startTest("Read playlist by id test - service unit");
	...
	void readPlaylistNameTest() {
		TestWatch.test = report.startTest("Read playlist by name test - service unit");
	...
	void updatePlaylistTest() {
		TestWatch.test = report.startTest("Updated playlist test - service unit");
	...
	void deletePlaylistTest() {
		TestWatch.test = report.startTest("Delete playlist test - service unit");
